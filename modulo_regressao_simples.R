...
#Esse módulo não precisa da entrada de outros módulos
...
regressao_simples_UI <- function(id, input_dados,banco){
        ns <- NS(id)
        tagList(
                fluidPage(
                           # Barra de navegação 
...
regressao_simples <- function(input, output, session, banco){
