...
sinan_aidsG$DT_TRI <- as.character(sinan_aidsG$DT_TRI)
...
sinan_sifilis$DT_TRI <- as.character(sinan_sifilis$DT_TRI)
...
sinan_sifilisG$DT_TRI <- as.character(sinan_sifilisG$DT_TRI)
...
sinan_sifilisC$DT_TRI <- as.character(sinan_sifilisC$DT_TRI)
...
sinan_tuberculose$DT_TRI <- as.character(sinan_tuberculose$DT_TRI)
